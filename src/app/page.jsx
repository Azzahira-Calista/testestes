...
<div className="home px-[1.5rem] py-[1rem] flex justify-center items-center min-h-screen">
<div className=" flex flex-col justify-center gap-2"> 
        <div className="job flex items-center gap-2">
          <p className="text-white">I do </p>
          <RotatingText
            texts={['Web Dev', 'App Dev', 'Motion Graphic', 'Ui/Ux', 'Graphic Design']}
